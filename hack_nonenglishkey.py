...
def main():
    ...
    # ciphertext = "ekatebrteigDegslnbsneoimsnormuidifatoraolfonpnenoeuapndanmiyoueantltismutflthsikohlehsns"
    # ciphertext = """ekatebrteigDegslnbsneoimsnormuidifatoraolfonpnenoeuapndanmiyoueantltismutflthsikohlehsns"""
    # ciphertext = "nGmni Tskcxipo esdskkxgmejvc"
    ciphertext = 'Iak rhsexzxmodg oh yug igexxh mnpm ctkk enhabywxj qxzlxkc Wkrxsqxx pgj Dvzdukg , tts mnpm ywhc pg ujmyittsbtv vucmxxuaibuc mu rrhtkytvagbzn lixxtrx. Zwx idfvtmoibuc pgh vxttztw zd lzxfaatzt kkhxggvn ihcpkj iak sxbteuefkcm uu lehmkbl zwtz pkk gxyxeotgz ih inukg tzitizl. Kcmxxxy pkk ynjvxj dg yrbkcmoubi bxxxm, zwx yikkczzw tts lovgoubipgit hl iak lhxz kkehxixj'
    # ciphertext = "Jsavdlzilj xsmu vvlajuv junvhsc bssejrjgio evjzftk ke ezcat dgicsc swcbmcqj suzrlafh, tlj ffdw fv lyue nejb uprslco lyu oro lyu tftq uewj. Yf jfstu, zfmwmuj, tudci lyql rhw eel zdkztw r bamyfx ejxqfzie, tqdcuv zd nzjjf swcbk, jjacb sihseww kxwdiwclwj yfke lyhwv-tadufjygeqd xhglfaewk, fh sxwjvwskuk. Kxwju sxwjvwskuk dejv sdfiwco jviwdrdv mzrj zrfhvdk zd lyu tftq. Tudci ae cathgxhsmylp qdje urd uckeg jgxulyuj dejv usjydp, qfu jzvo wofwiywesw iuvlswu vdlyv jxwrh kkhwji"
    # ciphertex = "Xmjpnhtfy niiyiipyoh uno ey ftydyz ni n pyno hm yovnouy hvy qynjotow ljmuyii. Eniyz mo hvy jyigqhi mx iguv niiyiipyohi, ihgzyohi dtqq ey neqy hm niiyii hvytj romdqyzwy noz tzyohtxb ihjyowhvi noz dynroyiiyi. Hvy hynuvyj dtqq nqim vnfy toztunhtmo mo vmd dyqq hvy ihgzyohi njy wjniltow hvy xgoznpyohnq xnuhi noz dvyhvyj vy oyyzi hm nqhyj hvytj hynuvtow hm yplvniti impy tplmjhnoh umouylhi."
    # ciphertext = "ekatebrteigDegslnbsneoimsnormuidifatoraolfonpnenoeuapndanmiyoueantltismutflthsikohlehsns"
...
# Create a possible key from the letters in allFreqScores
        ...
        if detectEnglish.isEnglish(decryptedText):
            ...
            print(decryptedText[:2000]) # only show first 200 characters
            print()
